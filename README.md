...
Using SAS, this project applies the cox regression model, stratified cox model, and other statistical methods such as the Log-Rank Test and Kaplan Meier curves to help visualize and propose a final model for a heart attack study.
...
One of my favorite passions is producing a radio show, Claws Radio, a show that hosts weekly music themes through 22 West Radio, a student-run radio station located at Cal State Long Beach.

A highlight is my collaboration with DJ Lance Rock in which I invited him as a guest for an interview/music appreciation. 
